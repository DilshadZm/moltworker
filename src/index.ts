...
function validateRequiredEnv(env: MoltbotEnv): string[] {
  ...
  // Check for AI Gateway or direct Anthropic/Gemini configuration
  if (env.AI_GATEWAY_API_KEY) {
    ...
    // Direct API access requires an API key (Anthropic, Gemini, or AI Gateway)
    missing.push('ANTHROPIC_API_KEY, GEMINI_API_KEY, or AI_GATEWAY_API_KEY');
  }
